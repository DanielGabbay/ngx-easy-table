...
class BaseComponent {
    ...
    drop($event) {
        ...
        if ((file === null || file === void 0 ? void 0 : file.type) !== 'application/json') {
            // eslint-disable-next-line no-console
        ...
        fileReader.onload = (event) => {
            var _a;
            this.data = JSON.parse((_a = event === null || event === void 0 ? void 0 : event.target) === null || _a === void 0 ? void 0 : _a.result);
            this.cdr.markForCheck();
        };
